...
let re = /dogs/gi;
let newstr = story.replace(re, "cats");
let newstr2 = newstr.replace("10", "100000");
let newstr3 = newstr2.replace("day", "night");
let result = newstr3.replace("great day", "brilliant night");
